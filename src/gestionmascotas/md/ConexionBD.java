    ...
    public static Connection obtenerConexion() throws SQLException {
        ...
        try {
            ...
            if (gestionmascotas.dp.controladores.SesionUsuario.getUsuarioActual() != null) {
                try (java.sql.PreparedStatement ps = conn.prepareStatement("SELECT set_config('app.current_user', ?, false), set_config('app.current_rol', ?, false)")) {
                    ps.setString(1, gestionmascotas.dp.controladores.SesionUsuario.getUsuarioActual().getCedula());
                    ps.setString(2, gestionmascotas.dp.controladores.SesionUsuario.getUsuarioActual().getCargo());
                    ps.execute();
                }
            }
            return conn;
